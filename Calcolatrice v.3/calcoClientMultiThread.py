#client calcoClientMultiThread.py 
import socket
import sys
import random
import os
...
#Vengono generate un certo numero di richieste (NUM_WORKERS) da inviare al server 
#Utilizzando tre modalità: Seriale, Multithread, Multiprocess
#vengono mostrati i tempi di esecuzione in tutti e tre o casi
